  ...
  const handleSocialSignIn = async (provider: string) => {
    try {
      ...
      if (result?.error) {
        ...
        setError(`Falha ao conectar com ${provider}. Verifique suas credenciais.`);
      }
    } catch (err) {
      console.error(`Erro crítico no login ${provider}:`, err);
      setError(`Ocorreu um erro inesperado ao tentar login com ${provider}.`);
    } finally {
    ...
    <div className="w-full min-h-screen grid lg:grid-cols-2 bg-[#0a0a0a]">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400 p-12 text-primary-foreground">
        ...
        <div className="relative z-20 flex items-end justify-center h-[500px]">
          {/* Cartoon Characters */}
          <div className="relative" style={{ width: '550px', height: '400px', transform: "scale(0.8)" }}>
            <div 
              ref={purpleRef}
      ...
      <div className="flex items-center justify-center p-8 bg-[#0a0a0a]">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-4xl font-black tracking-tighter mb-2 text-white uppercase">Bem-vindo de volta</h1>
            <p className="text-gray-400 text-sm font-medium">Insira seus dados para entrar no jogo.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-12 bg-black/40 border-white/5 focus:border-yellow-500/50 rounded-xl"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-black/40 border-white/5 focus:border-yellow-500/50 rounded-xl"
                />
                <button
                  type="button"
            ...
            <Button 
              type="submit" 
              className="w-full h-12 text-sm font-black uppercase tracking-widest bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 text-black shadow-[0_10px_20px_rgba(234,179,8,0.2)]" 
              size="lg" 
              disabled={isLoading}
            >
              {isLoading ? "Validando..." : "Entrar no Bolão"}
            </Button>
          </form>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-[10px] uppercase font-bold text-gray-600">
              <span className="bg-[#0a0a0a] px-4 tracking-widest">Ou continue com</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button 
              ...
              className="h-12 bg-white/5 border-white/5 hover:bg-white/10 text-white font-bold text-xs disabled:opacity-50"
              type="button"
          ...
          <div className="mt-10 text-center">
            <p className="text-gray-500 font-medium text-xs">
              Não tem uma conta?{" "}
              <a href="/register" className="text-yellow-500 hover:text-yellow-400 font-black uppercase tracking-widest ml-1">
                Cadastre-se agora
              </a>
            </p>
          </div>
